...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncTreeRot3_id20 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncTreeRot3_id20>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncTreeRot3_id20] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
