...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncCube_id12 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncCube_id12>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncCube_id12] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
