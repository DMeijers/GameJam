...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncTreeRot_id17 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncTreeRot_id17>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncTreeRot_id17] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
