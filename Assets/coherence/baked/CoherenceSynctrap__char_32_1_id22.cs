...
namespace Coherence.Generated
{
	...
	public class CoherenceSynctrap__char_32_1_id22 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSynctrap__char_32_1_id22>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSynctrap__char_32_1_id22] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
