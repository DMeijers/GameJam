...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncBuildingRot1_id9 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncBuildingRot1_id9>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncBuildingRot1_id9] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
