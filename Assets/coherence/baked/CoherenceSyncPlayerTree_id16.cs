...
namespace Coherence.Generated
{
	...
	public class Binding_6e41740ccd468754ebce2e5459d93cdd_03988d14_e364_4e85_80f3_85a566ae74c5 : BoolAnimatorParameterBinding
	{
		...
		public override string CoherenceComponentName => "PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214";
		...
		{
			var update = (PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214)coherenceComponent;
		...
		{
			return new PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214();
		}
	}
	...
	public class CoherenceSyncPlayerTree_id16 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncPlayerTree_id16>();
			...
			if (coherenceSync.TryGetBindingByGuid("03988d14-e364-4e85-80f3-85a566ae74c5", "IsMoving", out Binding InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_IsMoving))
			{
				var clone = new Binding_6e41740ccd468754ebce2e5459d93cdd_03988d14_e364_4e85_80f3_85a566ae74c5();
				InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_IsMoving.CloneTo(clone);
				coherenceSync.Bindings[coherenceSync.Bindings.IndexOf(InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_IsMoving)] = clone;
			}
			else
			{
				logger.Error("Couldn't find binding (UnityEngine.Animator).IsMoving");
			}
			if (coherenceSync.TryGetBindingByGuid("5a5d4943-7ac3-4a7a-8194-f6794894294c", "GoingLeft", out Binding InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_GoingLeft))
			{
				var clone = new Binding_6e41740ccd468754ebce2e5459d93cdd_5a5d4943_7ac3_4a7a_8194_f6794894294c();
				InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_GoingLeft.CloneTo(clone);
				coherenceSync.Bindings[coherenceSync.Bindings.IndexOf(InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_GoingLeft)] = clone;
			}
			else
			{
				logger.Error("Couldn't find binding (UnityEngine.Animator).GoingLeft");
			}
			if (coherenceSync.TryGetBindingByGuid("03b8f679-6107-4276-9d2e-e80883db1d97", "GoingRight", out Binding InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_GoingRight))
			{
				var clone = new Binding_6e41740ccd468754ebce2e5459d93cdd_03b8f679_6107_4276_9d2e_e80883db1d97();
				InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_GoingRight.CloneTo(clone);
				coherenceSync.Bindings[coherenceSync.Bindings.IndexOf(InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_GoingRight)] = clone;
			}
			else
			{
				logger.Error("Couldn't find binding (UnityEngine.Animator).GoingRight");
			}
			if (coherenceSync.TryGetBindingByGuid("42f1511a-b47b-4946-8490-f591e3844cf3", "GoingBack", out Binding InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_GoingBack))
			{
				var clone = new Binding_6e41740ccd468754ebce2e5459d93cdd_42f1511a_b47b_4946_8490_f591e3844cf3();
				InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_GoingBack.CloneTo(clone);
				coherenceSync.Bindings[coherenceSync.Bindings.IndexOf(InternalPlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_PlayerTree_id16_UnityEngine__char_46_Animator_5624696503662188214_GoingBack)] = clone;
			}
			else
			{
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncPlayerTree_id16] Unhandled command: {command.GetType()}.");
					break;
			}
		}
