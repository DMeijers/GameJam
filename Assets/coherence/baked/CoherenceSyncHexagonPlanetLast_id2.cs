...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncHexagonPlanetLast_id2 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncHexagonPlanetLast_id2>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncHexagonPlanetLast_id2] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
