...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncTreeRot1_id18 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncTreeRot1_id18>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncTreeRot1_id18] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
