...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncbuilding2_id9 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncbuilding2_id9>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncbuilding2_id9] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
