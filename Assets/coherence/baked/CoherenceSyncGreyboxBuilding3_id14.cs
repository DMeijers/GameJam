...
namespace Coherence.Generated
{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'GreyboxBuilding3' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncGreyboxBuilding3_id14 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncGreyboxBuilding3_id14>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncGreyboxBuilding3_id14] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
