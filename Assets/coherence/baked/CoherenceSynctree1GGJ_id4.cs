...
namespace Coherence.Generated
{
	...
	public class CoherenceSynctree1GGJ_id4 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSynctree1GGJ_id4>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSynctree1GGJ_id4] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
