...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncGreyboxBuilding2_id1 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncGreyboxBuilding2_id1>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncGreyboxBuilding2_id1] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
