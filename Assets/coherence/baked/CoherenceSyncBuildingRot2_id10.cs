...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncBuildingRot2_id10 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncBuildingRot2_id10>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncBuildingRot2_id10] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
