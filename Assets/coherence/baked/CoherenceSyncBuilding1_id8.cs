...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncBuilding1_id8 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncBuilding1_id8>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncBuilding1_id8] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
