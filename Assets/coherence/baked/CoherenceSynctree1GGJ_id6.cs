...
namespace Coherence.Generated
{
	...
	public class CoherenceSynctree1GGJ_id6 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSynctree1GGJ_id6>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSynctree1GGJ_id6] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
