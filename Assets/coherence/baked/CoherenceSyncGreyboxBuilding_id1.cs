...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncGreyboxBuilding_id1 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncGreyboxBuilding_id1>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncGreyboxBuilding_id1] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
