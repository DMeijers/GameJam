...
namespace Coherence.Generated
{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'Trap' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncTrap_id21 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncTrap_id21>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncTrap_id21] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
