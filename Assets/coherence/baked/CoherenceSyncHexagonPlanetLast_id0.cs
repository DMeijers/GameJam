...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncHexagonPlanetLast_id0 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncHexagonPlanetLast_id0>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncHexagonPlanetLast_id0] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
