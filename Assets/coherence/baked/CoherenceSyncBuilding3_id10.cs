...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncBuilding3_id10 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncBuilding3_id10>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncBuilding3_id10] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
