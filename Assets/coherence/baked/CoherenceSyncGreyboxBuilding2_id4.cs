...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncGreyboxBuilding2_id4 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncGreyboxBuilding2_id4>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncGreyboxBuilding2_id4] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
