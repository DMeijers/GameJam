...
namespace Coherence.Generated
{
	...
	public class CoherenceSynctree3GGJ_id6 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSynctree3GGJ_id6>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSynctree3GGJ_id6] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
