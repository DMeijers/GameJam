...
namespace Coherence.Generated
{
	...
	public class Binding_6d57491473fb68a4a87f6eca2180c0d4_1bddc179_aa70_46b9_b129_d3123e91f180 : BoolAnimatorParameterBinding
	{
		...
		public override string CoherenceComponentName => "PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149";
		...
		{
			var update = (PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149)coherenceComponent;
		...
		{
			return new PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149();
		}
	}
	...
	public class CoherenceSyncPlayerHuman_id19 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncPlayerHuman_id19>();
			...
			if (coherenceSync.TryGetBindingByGuid("1bddc179-aa70-46b9-b129-d3123e91f180", "IsMoving", out Binding InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_IsMoving))
			{
				var clone = new Binding_6d57491473fb68a4a87f6eca2180c0d4_1bddc179_aa70_46b9_b129_d3123e91f180();
				InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_IsMoving.CloneTo(clone);
				coherenceSync.Bindings[coherenceSync.Bindings.IndexOf(InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_IsMoving)] = clone;
			}
			else
			{
				logger.Error("Couldn't find binding (UnityEngine.Animator).IsMoving");
			}
			if (coherenceSync.TryGetBindingByGuid("76ec269b-54fa-4e06-9197-073eac35d094", "GoingLeft", out Binding InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_GoingLeft))
			{
				var clone = new Binding_6d57491473fb68a4a87f6eca2180c0d4_76ec269b_54fa_4e06_9197_073eac35d094();
				InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_GoingLeft.CloneTo(clone);
				coherenceSync.Bindings[coherenceSync.Bindings.IndexOf(InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_GoingLeft)] = clone;
			}
			else
			{
				logger.Error("Couldn't find binding (UnityEngine.Animator).GoingLeft");
			}
			if (coherenceSync.TryGetBindingByGuid("3505f0c8-e79f-4ad8-8777-4eeb5f0b1e8f", "GoingRight", out Binding InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_GoingRight))
			{
				var clone = new Binding_6d57491473fb68a4a87f6eca2180c0d4_3505f0c8_e79f_4ad8_8777_4eeb5f0b1e8f();
				InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_GoingRight.CloneTo(clone);
				coherenceSync.Bindings[coherenceSync.Bindings.IndexOf(InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_GoingRight)] = clone;
			}
			else
			{
				logger.Error("Couldn't find binding (UnityEngine.Animator).GoingRight");
			}
			if (coherenceSync.TryGetBindingByGuid("064cf339-acfa-46a1-bb5e-fbe7275c3722", "GoingBack", out Binding InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_GoingBack))
			{
				var clone = new Binding_6d57491473fb68a4a87f6eca2180c0d4_064cf339_acfa_46a1_bb5e_fbe7275c3722();
				InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_GoingBack.CloneTo(clone);
				coherenceSync.Bindings[coherenceSync.Bindings.IndexOf(InternalPlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_PlayerHuman_id19_UnityEngine__char_46_Animator_5819893876217580149_GoingBack)] = clone;
			}
			else
			{
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncPlayerHuman_id19] Unhandled command: {command.GetType()}.");
					break;
			}
		}
