...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncGreyboxBuilding_id3 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncGreyboxBuilding_id3>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncGreyboxBuilding_id3] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
