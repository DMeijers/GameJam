...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncPlanetIndividualOrigins_id20 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncPlanetIndividualOrigins_id20>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncPlanetIndividualOrigins_id20] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
