...
namespace Coherence.Generated
{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'PlanetIndividualOrigins' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncPlanetIndividualOrigins_id12 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncPlanetIndividualOrigins_id12>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncPlanetIndividualOrigins_id12] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
