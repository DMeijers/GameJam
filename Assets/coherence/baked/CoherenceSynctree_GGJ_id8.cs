...
namespace Coherence.Generated
{
	...
	public class CoherenceSynctree_GGJ_id8 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSynctree_GGJ_id8>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSynctree_GGJ_id8] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
